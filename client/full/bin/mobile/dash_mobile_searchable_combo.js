class DashMobileSearchableCombo {
    ...
    setup_connections () {
        ...
        this.input.on("click", (event, reclick=false) => {
            if (reclick) {
                // Force redraw of datalist
                // this.option_rows.Last().detach();
                //
                // requestAnimationFrame(function () {
                //     this.datalist.append(this.option_rows.Last());
                // });
    ...
    trigger_reclick () {
        setTimeout(
            () => {
                ...
                // keyboard unless re-clicked after initial draw
                this.input.trigger("focus");
                this.input.trigger("click", [true]);
            },
            300
        );
    }
