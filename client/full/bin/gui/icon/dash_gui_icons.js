function DashGuiIcons (icon) {
    ...
    this.icon_map = {
        ...
        "angle_left":              new DashGuiIconDefinition(this.icon, "Angle Left", this.weight["solid"], "angle-double-left"),
        "angle_right":             new DashGuiIconDefinition(this.icon, "Angle Right", this.weight["solid"], "angle-double-right"),
        ...
        "arrow_right_alt_2_heavy": new DashGuiIconDefinition(this.icon, "Arrow Right Alt 2", this.weight["solid"], "arrow-alt-right"),
        "arrow_right_alt_heavy":   new DashGuiIconDefinition(this.icon, "Arrow Right Alt (Heavy)", this.weight["solid"], "arrow-right"),
        "arrow_right_circled":     new DashGuiIconDefinition(this.icon, "Arrow Right Circled", this.weight["regular"], "arrow-circle-right"),
        "arrow_right_circled_alt": new DashGuiIconDefinition(this.icon, "Arrow Right Circled Alt", this.weight["regular"], "arrow-alt-circle-right"),
        ...
        "backward":                new DashGuiIconDefinition(this.icon, "Backward", this.weight["solid"], "backward"),
        ...
        "bolt":                    new DashGuiIconDefinition(this.icon, "Bolt", this.weight["solid"], "bolt"),
        ...
        "camera_alt":              new DashGuiIconDefinition(this.icon, "Camera (Alt)", this.weight["regular"], "camera-retro"),
        ...
        "code_branch":             new DashGuiIconDefinition(this.icon, "Code Branch", this.weight["regular"], "code-branch"),
        "code_merge":              new DashGuiIconDefinition(this.icon, "Code Merge", this.weight["regular"], "code-merge"),
        ...
        "font_alt":                new DashGuiIconDefinition(this.icon, "Font", this.weight["regular"], "bold"),
        "football":                new DashGuiIconDefinition(this.icon, "Football", this.weight["regular"], "football-ball"),
        "forward":                 new DashGuiIconDefinition(this.icon, "Forward", this.weight["solid"], "forward"),
        "gauge":                   new DashGuiIconDefinition(this.icon, "Gauge", this.weight["regular"], "tachometer-alt"),
        ...
        "graph":                   new DashGuiIconDefinition(this.icon, "Graph", this.weight["solid"], "bezier-curve"),
        ...
        "hashtag":                 new DashGuiIconDefinition(this.icon, "Hashtag", this.weight["solid"], "hashtag"),
        ...
        "hyphen":                  new DashGuiIconDefinition(this.icon, "Hyphen", this.weight["regular"], "minus"),
        "hyphen_solid":            new DashGuiIconDefinition(this.icon, "Hyphen (Solid)", this.weight["solid"], "minus"),
        ...
        "music_alt":               new DashGuiIconDefinition(this.icon, "Music (Alt)", this.weight["regular"], "music-alt"),
        "navigation":              new DashGuiIconDefinition(this.icon, "Navigation - Top Level", this.weight["regular"], "tasks"),
        "next":                    new DashGuiIconDefinition(this.icon, "Next", this.weight["solid"], "step-forward"),
        ...
        "previous":                new DashGuiIconDefinition(this.icon, "Previous", this.weight["solid"], "step-backward"),
        ...
        "random":                  new DashGuiIconDefinition(this.icon, "Random", this.weight["solid"], "random"),
        ...
        "share_alt":               new DashGuiIconDefinition(this.icon, "Share (Alt)", this.weight["regular"],"share-alt"),
        ...
        "text":                    new DashGuiIconDefinition(this.icon, "Text", this.weight["regular"], "font"),
        "terminal":                new DashGuiIconDefinition(this.icon, "Terminal", this.weight["regular"], "terminal"),
        "thumbs_up":               new DashGuiIconDefinition(this.icon, "Thumbs Up", this.weight["regular"], "thumbs-up"),
