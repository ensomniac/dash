...
function DashGuiButton(Label, Callback, Bind){
    ...
    this.setup_styles = function(){
        ...
        this.html.css({
            "background": d.Color.ButtonColor,
            "cursor": "pointer",
            "height": d.Size.RowHeight-d.Size.Padding,
            "border-radius": 2,
        ...
        this.highlight.css({
            ...
            "right": 0,
            "bottom": 0,
            "background": d.Color.ButtonHoverColor,
            "opacity": 0,
            "border-radius": 2,
        });
        this.load_bar.css({
        ...
        this.label.css({
            "height": d.Size.RowHeight-d.Size.Padding,
            "line-height": (d.Size.RowHeight-d.Size.Padding) + "px",
            "text-align": "center",
        });
    };
    ...
    this.SetColor = function(background_color){
        this.html.css({
...
function DashGuiInput(placeholder_text){
    ...
    this.row_height = d.Size.RowHeight;
    this.column_width = window.ColumnWidth || (this.row_height*5);
    this.html = $("<div></div>");
...
function DashGuiLayoutUserProfile(){
    this.html = $("<div>DashGuiLayoutUserProfile</div>");
    this.html = $("<div></div>");
    this.user_data = Dash.User.Data;
    this.as_overview = false;
    this.setup_styles = function(){
        this.email_row = new d.Gui.InputRow("Email", this.user_data["email"], "Email");
        this.new_password_row = new d.Gui.InputRow("Update Password", "", "New Password", "Update", this.update_password, this);
        this.first_name = new d.Gui.InputRow("First Name", this.user_data["first_name"], "First Name", "Save", this.update_first_name, this);
        this.last_name = new d.Gui.InputRow("Last Name", this.user_data["last_name"], "Last Name", "Save", this.update_last_name, this);
        ...
        if (!this.as_overview) {
            this.is_admin.DisableSaveButton(false);
        };
        this.html.append(this.email_row.html);
        this.html.append(this.new_password_row.html);
        this.html.append(this.first_name.html);
        this.html.append(this.last_name.html);
        this.html.append(this.is_admin.html);
        if (this.hidden_mindtwins_csv) {
            this.html.append(this.hidden_mindtwins_csv.html);
        };
        if (!this.as_overview) {
            this.logout_button = new d.Gui.Button("Logout", this.log_out, this);
